...
export default function SellerHeader() {
  return (
    <div className="w-full fixed top-10 z-30 max-w-7xl mx-auto py-6 boder-2 border-red-500">
      <header className="bg-neutral-50 shadow-sm gap-x-4 px-4 md:px-6 py-4 md:py-6 border-b border-gray-200 flex flex-col">
        <BreadCrumbSeller />
