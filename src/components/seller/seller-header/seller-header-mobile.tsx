...
export default function SellerHeaderMobile() {
  return (
    <div className="w-full fixed top-0 z-50 bg-primary drop-shadow ">
      <header className="gap-x-4 p-4 flex flex-row justify-between items-center bg-primary max-w-7xl mx-auto">
